var url = ['/Documentos/APIValorant','/Documentos/CarruselFotos', '/Documentos/ProyectoWebResponsiveMobileFirst(BreakPoint)', '/Documentos/WebCadenaJSON'];
var web = ['Personajes de Valorant con API','Carrusel Fotos', 'Proyecto WebResponsive Mobile First (BreakPoint)', 'Web con cadena JSON'];
var fotoscarrusel = ['/Documentos/INDEX/fotos/4.png','/Documentos/INDEX/fotos/1.png', '/Documentos/INDEX/fotos/2.png','/Documentos/INDEX/fotos/3.png'];
var fotoactual = 0;
